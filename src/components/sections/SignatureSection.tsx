            ...
            <div className="lg:col-span-5 flex flex-col justify-center text-left">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  transition={{ duration: 0.4 }}
                >
                  <span className="text-[10px] font-sans font-bold tracking-widest uppercase text-brand-teal mb-3 block">
                    Featured Masterpiece
                  </span>
                  ...
                  <div className="flex items-baseline gap-6 pt-6 border-t border-border">
                      ...
                      href={getWhatsAppUrl(selectedProduct.name, selectedProduct.category)}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="h-[52px] px-8 bg-brand-teal text-white text-xs uppercase tracking-widest font-semibold transition-all duration-300 hover:opacity-90 rounded-[8px] cursor-pointer inline-flex items-center justify-center gap-2"
                    >
            ...
            {products.map((product) => {
              ...
              return (
                <div
                  ...
                  onClick={() => setSelectedProduct(product)}
                  className={`group cursor-pointer p-4 bg-surface border transition-all duration-500 rounded-[8px] shadow-sm ${
                    isSelected ? "border-brand-teal" : "border-border hover:border-brown-700"
                  }`}
                >
                  {/* Portrait 4:5 framed photography */}
                  <div className="relative aspect-[4/5] overflow-hidden mb-6 bg-bg-secondary rounded-[6px] border border-border">
                  ...
                  <div className="text-left">
                    <div className="flex justify-between items-baseline gap-2 mb-2">
                      ...
                      <span className="text-xs font-mono font-medium text-brand-teal flex items-center gap-0.5">
                        <Star className="w-2.5 h-2.5 fill-brand-teal text-brand-teal" />{" "}
                        {product.rating}
                      </span>
                    </div>

                    <h4 className="text-lg font-display font-bold text-black mb-2 tracking-tight group-hover:text-brand-teal transition-colors">
                      {product.name}
                    </h4>
                    ...
                    <div className="pt-3 border-t border-border">
                        ...
                        href={getWhatsAppUrl(product.name, product.category)}
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="w-full h-10 bg-brand-teal text-white text-[11px] uppercase tracking-widest font-semibold transition-all duration-300 hover:opacity-90 rounded-[6px] inline-flex items-center justify-center gap-1.5"
                      >
